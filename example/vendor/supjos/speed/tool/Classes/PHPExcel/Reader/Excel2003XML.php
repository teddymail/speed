...
class PHPExcel_Reader_Excel2003XML extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    public function loadIntoExisting( $pFilename, PHPExcel $objPHPExcel )
    {
        ...
        $underlineStyles = [PHPExcel_Style_Font::UNDERLINE_NONE, PHPExcel_Style_Font::UNDERLINE_DOUBLE,
            PHPExcel_Style_Font::UNDERLINE_DOUBLEACCOUNTING, PHPExcel_Style_Font::UNDERLINE_SINGLE,
            PHPExcel_Style_Font::UNDERLINE_SINGLEACCOUNTING];
        $verticalAlignmentStyles = [PHPExcel_Style_Alignment::VERTICAL_BOTTOM, PHPExcel_Style_Alignment::VERTICAL_TOP,
            PHPExcel_Style_Alignment::VERTICAL_CENTER, PHPExcel_Style_Alignment::VERTICAL_JUSTIFY];
        $horizontalAlignmentStyles =
            [PHPExcel_Style_Alignment::HORIZONTAL_GENERAL, PHPExcel_Style_Alignment::HORIZONTAL_LEFT,
                PHPExcel_Style_Alignment::HORIZONTAL_RIGHT, PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
                PHPExcel_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS, PHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY];
                ...
                switch ( $styleType ) {
                        ...
                        foreach ( $styleAttributes as $styleAttributeKey => $styleAttributeValue ) {
                            ...
                            switch ( $styleAttributeKey ) {
                                ...
                                case 'Size' :
                                    ...
                                    break;
                                case 'Color' :
                                    $this->_styles[ $styleID ][ 'font' ][ 'color' ][ 'rgb' ] =
                    ...
                    case 'Interior' :
                        foreach ( $styleAttributes as $styleAttributeKey => $styleAttributeValue ) {
                            ...
                            switch ( $styleAttributeKey ) {
                                case 'Color' :
                                    $this->_styles[ $styleID ][ 'fill' ][ 'color' ][ 'rgb' ] =
                                        substr( $styleAttributeValue, 1 );
                                    break;
                            }
                        }
