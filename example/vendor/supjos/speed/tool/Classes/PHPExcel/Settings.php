...
class PHPExcel_Settings
{
    ...
    private static $_chartRenderers = [self::CHART_RENDERER_JPGRAPH,];
    private static $_pdfRenderers   = [self::PDF_RENDERER_TCPDF, self::PDF_RENDERER_DOMPDF, self::PDF_RENDERER_MPDF,];
