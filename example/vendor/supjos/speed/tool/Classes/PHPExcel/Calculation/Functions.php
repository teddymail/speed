...
class PHPExcel_Calculation_Functions
{
     ...
     * @var array
     */
    protected static $_errorCodes = ['null'        => '#NULL!', 'divisionbyzero' => '#DIV/0!', 'value' => '#VALUE!',
                                     'reference'   => '#REF!', 'name' => '#NAME?', 'num' => '#NUM!', 'na' => '#N/A',
    ...
    public static function setReturnDateType( $returnDateType )
    {
        if ( ( $returnDateType == self::RETURNDATE_PHP_NUMERIC ) ||
             ( $returnDateType == self::RETURNDATE_PHP_OBJECT ) || ( $returnDateType == self::RETURNDATE_EXCEL )
        ) {
...
if ( ( !function_exists( 'mb_str_replace' ) ) && ( function_exists( 'mb_substr' ) ) &&
     ( function_exists( 'mb_strlen' ) ) && ( function_exists( 'mb_strpos' ) )
) {
    ...
    function mb_str_replace( $search, $replace, $subject )
    {
        ...
        foreach ( ( array )$search as $key => $s ) {
            ...
            while ( $pos !== FALSE ) {
                $subject = mb_substr( $subject, 0, $pos, 'UTF-8' ) . $r .
