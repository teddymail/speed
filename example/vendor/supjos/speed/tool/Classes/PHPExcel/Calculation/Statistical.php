...
class PHPExcel_Calculation_Statistical
{
    ...
    public static function AVEDEV()
    {
        ...
        if ( $aMean != PHPExcel_Calculation_Functions::DIV0() ) {
            ...
            foreach ( $aArgs as $k => $arg ) {
                if ( ( is_bool( $arg ) ) && ( ( !PHPExcel_Calculation_Functions::isCellValue( $k ) ) ||
    ...
    public static function BETAINV( $probability, $alpha, $beta, $rMin = 0, $rMax = 1 )
    {
        ...
        if ( ( is_numeric( $probability ) ) && ( is_numeric( $alpha ) ) && ( is_numeric( $beta ) ) &&
             ( is_numeric( $rMin ) ) && ( is_numeric( $rMax ) )
        ) {
            if ( ( $alpha <= 0 ) || ( $beta <= 0 ) || ( $rMin == $rMax ) || ( $probability <= 0 ) ||
                 ( $probability > 1 )
            ) {
                return PHPExcel_Calculation_Functions::NaN();
            }
    ...
    private static function _logBeta( $p, $q )
    {
        if ( $p != self::$_logBetaCache_p || $q != self::$_logBetaCache_q ) {
            ...
            if ( ( $p <= 0.0 ) || ( $q <= 0.0 ) || ( ( $p + $q ) > LOG_GAMMA_X_MAX_VALUE ) ) {
                ...
                self::$_logBetaCache_result =
                    self::_logGamma( $p ) + self::_logGamma( $q ) - self::_logGamma( $p + $q );
            }
        }
    ...
    private static function _logGamma( $x )
    {
        ...
        static $lg_p1 = [4.945235359296727046734888, 201.8112620856775083915565, 2290.838373831346393026739,
        ...
        static $lg_p2 = [4.974607845568932035012064, 542.4138599891070494101986, 15506.93864978364947665077,
        ...
        static $lg_p4 = [14745.02166059939948905062, 2426813.369486704502836312, 121475557.4045093227939592,
        ...
        static $lg_q1 = [67.48212550303777196073036, 1113.332393857199323513008, 7738.757056935398733233834,
        ...
        static $lg_q2 = [183.0328399370592604055942, 7765.049321445005871323047, 133190.3827966074194402448,
        ...
        static $lg_q4 = [2690.530175870899333379843, 639388.5654300092398984238, 41355999.30241388052042842,
        ...
        static $lg_c = [-0.001910444077728, 8.4171387781295e-4, -5.952379913043012e-4, 7.93650793500350248e-4,
        ...
        if ( ( is_numeric( $value ) ) && ( is_numeric( $trials ) ) && ( is_numeric( $probability ) ) ) {
            ...
            if ( ( is_numeric( $cumulative ) ) || ( is_bool( $cumulative ) ) ) {
                if ( $cumulative ) {
                    $summer = 0;
                    for ( $i = 0; $i <= $value; ++$i ) {
                        $summer += PHPExcel_Calculation_MathTrig::COMBIN( $trials, $i ) * pow( $probability, $i ) *
                                   pow( 1 - $probability, $trials - $i );
                    }
                    
                    return $summer;
                } else {
                    return PHPExcel_Calculation_MathTrig::COMBIN( $trials, $value ) * pow( $probability, $value ) *
    ...
    private static function _gamma( $data )
    {
        ...
        static $p = [1 => 76.18009172947146, 2 => -86.50532032941677, 3 => 24.01409824083091, 4 => -1.231739572450155,
                     5 => 1.208650973866179e-3, 6 => -5.395239384953e-6];
    ...
    private static function _inverse_ncdf( $p )
    {
        ...
        static $a = [1 => -3.969683028665376e+01, 2 => 2.209460984245205e+02, 3 => -2.759285104469687e+02,
                     4 => 1.383577518672690e+02, 5 => -3.066479806614716e+01, 6 => 2.506628277459239e+00];
        
        static $b = [1 => -5.447609879822406e+01, 2 => 1.615858368580409e+02, 3 => -1.556989798598866e+02,
                     4 => 6.680131188771972e+01, 5 => -1.328068155288572e+01];
        
        static $c = [1 => -7.784894002430293e-03, 2 => -3.223964580411365e-01, 3 => -2.400758277161838e+00,
                     4 => -2.549732539343734e+00, 5 => 4.374664141464968e+00, 6 => 2.938163982698783e+00];
        
        static $d = [1 => 7.784695709041462e-03, 2 => 3.224671290700398e-01, 3 => 2.445134137142996e+00,
        ...
        if ( 0 < $p && $p < $p_low ) {
            ...
            return ( ( ( ( ( $c[ 1 ] * $q + $c[ 2 ] ) * $q + $c[ 3 ] ) * $q + $c[ 4 ] ) * $q + $c[ 5 ] ) * $q +
            ...
            return ( ( ( ( ( $a[ 1 ] * $r + $a[ 2 ] ) * $r + $a[ 3 ] ) * $r + $a[ 4 ] ) * $r + $a[ 5 ] ) * $r +
                     $a[ 6 ] ) * $q /
    ...
    public static function CRITBINOM( $trials, $probability, $alpha )
    {
        ...
        if ( ( is_numeric( $trials ) ) && ( is_numeric( $probability ) ) && ( is_numeric( $alpha ) ) ) {
            ...
            if ( $alpha <= 0.5 ) {
                ...
                $trialsApprox = 0 - ( $t + ( 2.515517 + 0.802853 * $t + 0.010328 * $t * $t ) /
                                           ( 1 + 1.432788 * $t + 0.189269 * $t * $t + 0.001308 * $t * $t * $t ) );
            } else {
                $t = sqrt( log( 1 / pow( 1 - $alpha, 2 ) ) );
                $trialsApprox = $t - ( 2.515517 + 0.802853 * $t + 0.010328 * $t * $t ) /
                                     ( 1 + 1.432788 * $t + 0.189269 * $t * $t + 0.001308 * $t * $t * $t );
            }
            $Guess =
                floor( $trials * $probability + $trialsApprox * sqrt( $trials * $probability * ( 1 - $probability ) ) );
            if ( $Guess < 0 ) {
                $Guess = 0;
            } elseif ( $Guess > $trials ) {
                $Guess = $trials;
        ...
        if ( ( is_numeric( $value ) ) && ( is_numeric( $a ) ) && ( is_numeric( $b ) ) ) {
            ...
            if ( ( is_numeric( $cumulative ) ) || ( is_bool( $cumulative ) ) ) {
                if ( $cumulative ) {
                    ...
                    return ( 1 / ( pow( $b, $a ) * self::_gamma( $a ) ) ) * pow( $value, $a - 1 ) *
                           exp( 0 - ( $value / $b ) );
                }
            }
        }
    ...
    public static function HYPGEOMDIST( $sampleSuccesses, $sampleNumber, $populationSuccesses, $populationNumber )
    {
        ...
        if ( ( is_numeric( $sampleSuccesses ) ) && ( is_numeric( $sampleNumber ) ) &&
             ( is_numeric( $populationSuccesses ) ) && ( is_numeric( $populationNumber ) )
        ) {
            if ( ( $sampleSuccesses < 0 ) || ( $sampleSuccesses > $sampleNumber ) ||
    ...
    public static function LINEST( $yValues, $xValues = NULL, $const = TRUE, $stats = FALSE )
    {
        $const = ( is_null( $const ) ) ? TRUE : ( boolean )PHPExcel_Calculation_Functions::flattenSingleValue( $const );
        $stats =
            ( is_null( $stats ) ) ? FALSE : ( boolean )PHPExcel_Calculation_Functions::flattenSingleValue( $stats );
        if ( is_null( $xValues ) ) {
        ...
        if ( $stats ) {
            return [[$bestFitLinear->getSlope(), $bestFitLinear->getSlopeSE(), $bestFitLinear->getGoodnessOfFit(),
                $bestFitLinear->getF(), $bestFitLinear->getSSRegression(),],
                [$bestFitLinear->getIntersect(), $bestFitLinear->getIntersectSE(),
                    $bestFitLinear->getStdevOfResiduals(), $bestFitLinear->getDFResiduals(),
    ...
    public static function LOGEST( $yValues, $xValues = NULL, $const = TRUE, $stats = FALSE )
    {
        ...
        $bestFitExponential = trendClass::calculate( trendClass::TREND_EXPONENTIAL, $yValues, $xValues, $const );
        if ( $stats ) {
            return [[$bestFitExponential->getSlope(), $bestFitExponential->getSlopeSE(),
                $bestFitExponential->getGoodnessOfFit(), $bestFitExponential->getF(),
                $bestFitExponential->getSSRegression(),],
                [$bestFitExponential->getIntersect(), $bestFitExponential->getIntersectSE(),
                    $bestFitExponential->getStdevOfResiduals(), $bestFitExponential->getDFResiduals(),
    ...
    public static function NORMDIST( $value, $mean, $stdDev, $cumulative )
    {
        ...
        if ( ( is_numeric( $value ) ) && ( is_numeric( $mean ) ) && ( is_numeric( $stdDev ) ) ) {
            ...
            if ( ( is_numeric( $cumulative ) ) || ( is_bool( $cumulative ) ) ) {
                if ( $cumulative ) {
                    return 0.5 * ( 1 + PHPExcel_Calculation_Engineering::_erfVal( ( $value - $mean ) /
                                                                                  ( $stdDev * sqrt( 2 ) ) ) );
                } else {
                    return ( 1 / ( SQRT2PI * $stdDev ) ) *
                           exp( 0 - ( pow( $value - $mean, 2 ) / ( 2 * ( $stdDev * $stdDev ) ) ) );
                }
            }
        }
    ...
    public static function NEGBINOMDIST( $failures, $successes, $probability )
    {
        ...
        if ( ( is_numeric( $failures ) ) && ( is_numeric( $successes ) ) && ( is_numeric( $probability ) ) ) {
            ...
            return ( PHPExcel_Calculation_MathTrig::COMBIN( $failures + $successes - 1, $successes - 1 ) ) *
                   ( pow( $probability, $successes ) ) * ( pow( 1 - $probability, $failures ) );
        }
    ...
    public static function PERCENTRANK( $valueSet, $value, $significance = 3 )
    {
        ...
        $value = PHPExcel_Calculation_Functions::flattenSingleValue( $value );
        $significance = ( is_null( $significance ) ) ? 3 :
    ...
    public static function PERMUT( $numObjs, $numInSet )
    {
        ...
        if ( ( is_numeric( $numObjs ) ) && ( is_numeric( $numInSet ) ) ) {
            ...
            return round( PHPExcel_Calculation_MathTrig::FACT( $numObjs ) /
                          PHPExcel_Calculation_MathTrig::FACT( $numObjs - $numInSet ) );
        }
        ...
        if ( ( is_numeric( $value ) ) && ( is_numeric( $alpha ) ) && ( is_numeric( $beta ) ) ) {
            ...
            if ( ( is_numeric( $cumulative ) ) || ( is_bool( $cumulative ) ) ) {
                if ( $cumulative ) {
                    ...
                    return ( $alpha / pow( $beta, $alpha ) ) * pow( $value, $alpha - 1 ) *
    ...
    private static function _inverse_ncdf2( $prob )
    {
        ...
        if ( abs( $y ) < 0.42 ) {
            ...
            $z = $c1 + $z * ( $c2 + $z * ( $c3 + $z * ( $c4 + $z * ( $c5 + $z * ( $c6 + $z * ( $c7 + $z * ( $c8 + $z *
                                                                                                                  $c9 ) ) ) ) ) ) );
            if ( $y < 0 ) {
                $z = -$z;
            }
    ...
    private static function _inverse_ncdf3( $p )
    {
        ...
        if ( abs( $q ) <= split1 ) {
            ...
            If ( $R <= $split2 ) {
                $R = $R - $const2;
                $z = ( ( ( ( ( ( ( $c7 * $R + $c6 ) * $R + $c5 ) * $R + $c4 ) * $R + $c3 ) * $R + $c2 ) * $R + $c1 ) *
                       $R + $c0 ) /
                ...
                $R = $R - $split2;
                $z = ( ( ( ( ( ( ( $e7 * $R + $e6 ) * $R + $e5 ) * $R + $e4 ) * $R + $e3 ) * $R + $e2 ) * $R + $e1 ) *
                       $R + $e0 ) /
