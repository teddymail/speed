...
class PHPExcel_Calculation_Engineering
{
     ...
     * @var mixed[]
     */
    private static $_conversionUnits = ['g'                                    => ['Group'       => 'Mass',
                                                                                   'Unit Name'   => 'Gram',
                                                                                   'AllowPrefix' => TRUE],
                                        'sg' => ['Group' => 'Mass', 'Unit Name' => 'Slug', 'AllowPrefix' => FALSE],
                                        'lbm' => ['Group'       => 'Mass', 'Unit Name' => 'Pound mass (avoirdupois)',
                                                  'AllowPrefix' => FALSE],
                                        'u' => ['Group'       => 'Mass', 'Unit Name' => 'U (atomic mass unit)',
                                                'AllowPrefix' => TRUE],
                                        'ozm' => ['Group'       => 'Mass', 'Unit Name' => 'Ounce mass (avoirdupois)',
                                                  'AllowPrefix' => FALSE],
                                        'm' => ['Group' => 'Distance', 'Unit Name' => 'Meter', 'AllowPrefix' => TRUE],
                                        'mi' => ['Group'       => 'Distance', 'Unit Name' => 'Statute mile',
                                                 'AllowPrefix' => FALSE],
                                        'Nmi' => ['Group'       => 'Distance', 'Unit Name' => 'Nautical mile',
                                                  'AllowPrefix' => FALSE],
                                        ...
                                        'ang' => ['Group'       => 'Distance', 'Unit Name' => 'Angstrom',
                                                  'AllowPrefix' => TRUE],
                                        'Pica' => ['Group'       => 'Distance', 'Unit Name' => 'Pica (1/72 in)',
                                                   'AllowPrefix' => FALSE],
                                        ...
                                        'atm' => ['Group'       => 'Pressure', 'Unit Name' => 'Atmosphere',
                                                  'AllowPrefix' => TRUE],
                                        'at' => ['Group'       => 'Pressure', 'Unit Name' => 'Atmosphere',
                                                 'AllowPrefix' => TRUE],
                                        'mmHg' => ['Group'       => 'Pressure', 'Unit Name' => 'mm of Mercury',
                                                   'AllowPrefix' => TRUE],
                                        ...
                                        'lbf' => ['Group'       => 'Force', 'Unit Name' => 'Pound force',
                                                  'AllowPrefix' => FALSE],
                                        'J' => ['Group' => 'Energy', 'Unit Name' => 'Joule', 'AllowPrefix' => TRUE],
                                        'e' => ['Group' => 'Energy', 'Unit Name' => 'Erg', 'AllowPrefix' => TRUE],
                                        'c' => ['Group'       => 'Energy', 'Unit Name' => 'Thermodynamic calorie',
                                                'AllowPrefix' => TRUE],
                                        'cal' => ['Group'       => 'Energy', 'Unit Name' => 'IT calorie',
                                                  'AllowPrefix' => TRUE],
                                        'eV' => ['Group'       => 'Energy', 'Unit Name' => 'Electron volt',
                                                 'AllowPrefix' => TRUE],
                                        'ev' => ['Group'       => 'Energy', 'Unit Name' => 'Electron volt',
                                                 'AllowPrefix' => TRUE],
                                        'HPh' => ['Group'       => 'Energy', 'Unit Name' => 'Horsepower-hour',
                                                  'AllowPrefix' => FALSE],
                                        'hh' => ['Group'       => 'Energy', 'Unit Name' => 'Horsepower-hour',
                                                 'AllowPrefix' => FALSE],
                                        'Wh' => ['Group'       => 'Energy', 'Unit Name' => 'Watt-hour',
                                                 'AllowPrefix' => TRUE],
                                        'wh' => ['Group'       => 'Energy', 'Unit Name' => 'Watt-hour',
                                                 'AllowPrefix' => TRUE],
                                        'flb' => ['Group'       => 'Energy', 'Unit Name' => 'Foot-pound',
                                                  'AllowPrefix' => FALSE],
                                        'BTU' => ['Group' => 'Energy', 'Unit Name' => 'BTU', 'AllowPrefix' => FALSE],
                                        'btu' => ['Group' => 'Energy', 'Unit Name' => 'BTU', 'AllowPrefix' => FALSE],
                                        'HP' => ['Group'       => 'Power', 'Unit Name' => 'Horsepower',
                                                 'AllowPrefix' => FALSE],
                                        'h' => ['Group'       => 'Power', 'Unit Name' => 'Horsepower',
                                                'AllowPrefix' => FALSE],
                                        ...
                                        'C' => ['Group'       => 'Temperature', 'Unit Name' => 'Celsius',
                                                'AllowPrefix' => FALSE],
                                        'cel' => ['Group'       => 'Temperature', 'Unit Name' => 'Celsius',
                                                  'AllowPrefix' => FALSE],
                                        'F' => ['Group'       => 'Temperature', 'Unit Name' => 'Fahrenheit',
                                                'AllowPrefix' => FALSE],
                                        'fah' => ['Group'       => 'Temperature', 'Unit Name' => 'Fahrenheit',
                                                  'AllowPrefix' => FALSE],
                                        'K' => ['Group'       => 'Temperature', 'Unit Name' => 'Kelvin',
                                                'AllowPrefix' => FALSE],
                                        'kel' => ['Group'       => 'Temperature', 'Unit Name' => 'Kelvin',
                                                  'AllowPrefix' => FALSE],
                                        'tsp' => ['Group'       => 'Liquid', 'Unit Name' => 'Teaspoon',
                                                  'AllowPrefix' => FALSE],
                                        'tbs' => ['Group'       => 'Liquid', 'Unit Name' => 'Tablespoon',
                                                  'AllowPrefix' => FALSE],
                                        'oz' => ['Group'       => 'Liquid', 'Unit Name' => 'Fluid Ounce',
                                                 'AllowPrefix' => FALSE],
                                        'cup' => ['Group' => 'Liquid', 'Unit Name' => 'Cup', 'AllowPrefix' => FALSE],
                                        'pt' => ['Group'       => 'Liquid', 'Unit Name' => 'U.S. Pint',
                                                 'AllowPrefix' => FALSE],
                                        'us_pt' => ['Group'       => 'Liquid', 'Unit Name' => 'U.S. Pint',
                                                    'AllowPrefix' => FALSE],
                                        'uk_pt' => ['Group'       => 'Liquid', 'Unit Name' => 'U.K. Pint',
                                                    'AllowPrefix' => FALSE],
    ...
    private static function _Besselk0( $fNum )
    {
        if ( $fNum <= 2 ) {
            $fNum2 = $fNum * 0.5;
            $y = ( $fNum2 * $fNum2 );
            $fRet = -log( $fNum2 ) * self::BESSELI( $fNum, 0 ) + ( -0.57721566 + $y * ( 0.42278420 + $y * ( 0.23069756 +
                                                                                                            $y *
                                                                                                            ( 0.3488590e-1 +
                                                                                                              $y *
                                                                                                              ( 0.262698e-2 +
            ...
            $y = 2 / $fNum;
            $fRet = exp( -$fNum ) / sqrt( $fNum ) * ( 1.25331414 + $y * ( -0.7832358e-1 + $y * ( 0.2189568e-1 + $y *
                                                                                                                ( -0.1062446e-1 +
                                                                                                                  $y *
                                                                                                                  ( 0.587872e-2 +
                                                                                                                    $y *
    ...
    private static function _Besselk1( $fNum )
    {
        if ( $fNum <= 2 ) {
            $fNum2 = $fNum * 0.5;
            $y = ( $fNum2 * $fNum2 );
            $fRet = log( $fNum2 ) * self::BESSELI( $fNum, 1 ) + ( 1 + $y * ( 0.15443144 + $y * ( -0.67278579 + $y *
                                                                                                               ( -0.18156897 +
                                                                                                                 $y *
                                                                                                                 ( -0.1919402e-1 +
                                                                                                                   $y *
            ...
            $y = 2 / $fNum;
            $fRet = exp( -$fNum ) / sqrt( $fNum ) * ( 1.25331414 + $y * ( 0.23498619 + $y * ( -0.3655620e-1 + $y *
                                                                                                              ( 0.1504268e-1 +
                                                                                                                $y *
                                                                                                                ( -0.780353e-2 +
                                                                                                                  $y *
    ...
    private static function _Bessely0( $fNum )
    {
        if ( $fNum < 8.0 ) {
            $y = ( $fNum * $fNum );
            $f1 = -2957821389.0 + $y * ( 7062834065.0 + $y * ( -512359803.6 + $y * ( 10879881.29 + $y * ( -86327.92757 +
                                                                                                          $y *
                                                                                                          228.4622733 ) ) ) );
            $f2 = 40076544269.0 +
    ...
    {
        $realNumber =
            ( is_null( $realNumber ) ) ? 0.0 : PHPExcel_Calculation_Functions::flattenSingleValue( $realNumber );
    ...
    public static function IMPRODUCT()
    {
        ...
        foreach ( $aArgs as $arg ) {
            ...
            $returnValue[ 'real' ] = ( $workValue[ 'real' ] * $parsedComplex[ 'real' ] ) -
                                     ( $workValue[ 'imaginary' ] * $parsedComplex[ 'imaginary' ] );
            $returnValue[ 'imaginary' ] = ( $workValue[ 'real' ] * $parsedComplex[ 'imaginary' ] ) +
                                          ( $workValue[ 'imaginary' ] * $parsedComplex[ 'real' ] );
        }
    ...
    public static function IMDIV( $complexDividend, $complexDivisor )
    {
        ...
        $d1 = ( $parsedComplexDividend[ 'real' ] * $parsedComplexDivisor[ 'real' ] ) +
              ( $parsedComplexDividend[ 'imaginary' ] * $parsedComplexDivisor[ 'imaginary' ] );
        $d2 = ( $parsedComplexDividend[ 'imaginary' ] * $parsedComplexDivisor[ 'real' ] ) -
              ( $parsedComplexDividend[ 'real' ] * $parsedComplexDivisor[ 'imaginary' ] );
        $d3 = ( $parsedComplexDivisor[ 'real' ] * $parsedComplexDivisor[ 'real' ] ) +
        ...
        foreach ( self::$_conversionUnits as $conversionUnit => $conversionGroup ) {
            if ( ( is_null( $group ) ) || ( $conversionGroup[ 'Group' ] == $group ) ) {
                $conversionGroups[ $conversionGroup[ 'Group' ] ][] =
                    ['unit' => $conversionUnit, 'description' => $conversionGroup[ 'Unit Name' ]];
            }
        }
    ...
    public static function CONVERTUOM( $value, $fromUOM, $toUOM )
    {
        ...
        if ( isset( self::$_conversionUnits[ $fromUOM ] ) ) {
            ...
            if ( ( isset( self::$_conversionUnits[ $fromUOM ] ) ) &&
                 ( self::$_conversionUnits[ $fromUOM ][ 'AllowPrefix' ] )
            ) {
                $unitGroup1 = self::$_conversionUnits[ $fromUOM ][ 'Group' ];
            } else {
                return PHPExcel_Calculation_Functions::NA();
        ...
        if ( isset( self::$_conversionUnits[ $toUOM ] ) ) {
            ...
            if ( ( isset( self::$_conversionUnits[ $toUOM ] ) ) &&
                 ( self::$_conversionUnits[ $toUOM ][ 'AllowPrefix' ] )
            ) {
                $unitGroup2 = self::$_conversionUnits[ $toUOM ][ 'Group' ];
            } else {
                return PHPExcel_Calculation_Functions::NA();
