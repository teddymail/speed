...
class PHPExcel_Chart
{
     ...
     */
    public function __construct( $name, PHPExcel_Chart_Title $title = NULL, PHPExcel_Chart_Legend $legend = NULL,
    ...
    {
        return ['cell'    => $this->_topLeftCellRef, 'xOffset' => $this->_topLeftXOffset,
    ...
    {
        return ['cell'    => $this->_bottomRightCellRef, 'xOffset' => $this->_bottomRightXOffset,
