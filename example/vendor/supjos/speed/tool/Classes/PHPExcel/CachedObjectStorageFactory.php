...
class PHPExcel_CachedObjectStorageFactory
{
     ...
     * @var string[]
     */
    private static $_storageMethods = [self::cache_in_memory, self::cache_in_memory_gzip,
        self::cache_in_memory_serialized, self::cache_igbinary, self::cache_to_phpTemp, self::cache_to_discISAM,
        self::cache_to_apc, self::cache_to_memcache, self::cache_to_wincache, self::cache_to_sqlite,
     ...
     */
    private static $_storageMethodDefaultParameters = [self::cache_in_memory            => [],
    ...
    public static function getInstance( PHPExcel_Worksheet $parent )
    {
        ...
        if ( $cacheMethodIsAvailable ) {
            $instance =
                new self::$_cacheStorageClass( $parent, self::$_storageMethodParameters[ self::$_cacheStorageMethod ] );
            if ( $instance !== NULL ) {
                return $instance;
            }
        }
