...
class trendClass
{
     ...
     * @var string[]
     * */
    private static $_trendTypes = [self::TREND_LINEAR, self::TREND_LOGARITHMIC, self::TREND_EXPONENTIAL,
        self::TREND_POWER];
     ...
     * @var string[]
     * */
    private static $_trendTypePolyOrders = [self::TREND_POLYNOMIAL_2, self::TREND_POLYNOMIAL_3,
            ...
            case self::TREND_BEST_FIT_NO_POLY :
                ...
                if ( $trendType != self::TREND_BEST_FIT_NO_POLY ) {
                    foreach ( self::$_trendTypePolyOrders as $trendMethod ) {
                        ...
                        $bestFit[ $trendMethod ] =
                            new PHPExcel_Polynomial_Best_Fit( $order, $yValues, $xValues, $const );
