...
class PHPExcel_Shared_Font
{
     ...
     * @var array
     */
    public static  $defaultColumnWidths = ['Arial' => [1  => ['px' => 24, 'width' => 12.00000000],
                                           ...
                                           'Calibri' => [1  => ['px' => 24, 'width' => 12.00000000],
                                                         2  => ['px' => 24, 'width' => 12.00000000],
                                                         3  => ['px' => 32, 'width' => 10.66406250],
                                                         4  => ['px' => 32, 'width' => 10.66406250],
                                                         5  => ['px' => 40, 'width' => 10.00000000],
                                           ...
                                           'Verdana' => [1  => ['px' => 24, 'width' => 12.00000000],
                                                         2  => ['px' => 24, 'width' => 12.00000000],
                                                         3  => ['px' => 32, 'width' => 10.66406250],
                                                         4  => ['px' => 32, 'width' => 10.66406250],
                                                         5  => ['px' => 40, 'width' => 10.00000000],
    ...
    private static $_autoSizeMethods    = [self::AUTOSIZE_METHOD_APPROX, self::AUTOSIZE_METHOD_EXACT,];
    /**
     * AutoSize method
     *
     * @var string
    ...
    public static function getDefaultColumnWidthByFont( PHPExcel_Style_Font $font, $pPixels = FALSE )
    {
        if ( isset( self::$defaultColumnWidths[ $font->getName() ][ $font->getSize() ] ) ) {
            ...
            $columnWidth = $pPixels ? self::$defaultColumnWidths[ $font->getName() ][ $font->getSize() ][ 'px' ] :
                self::$defaultColumnWidths[ $font->getName() ][ $font->getSize() ][ 'width' ];
        } else {
            // We don't have data for this particular font and size, use approximation by
            // extrapolating from Calibri 11
            $columnWidth = $pPixels ? self::$defaultColumnWidths[ 'Calibri' ][ 11 ][ 'px' ] :
