...
class PHPExcel_IOFactory
{
     ...
     * @static
     */
    private static $_searchLocations = [['type'  => 'IWriter', 'path' => 'PHPExcel/Writer/{0}.php',
     ...
     * @static
     */
    private static $_autoResolveClasses = ['Excel2007', 'Excel5', 'Excel2003XML', 'OOCalc', 'SYLK', 'Gnumeric', 'HTML',
        'CSV',];
