...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    private function _buildWorksheetEschers()
    {
        ...
        foreach ( $this->_phpExcel->getAllsheets() as $sheet ) {
            ...
            $filterRange = $sheet->getAutoFilter()
                                 ->getRange();
    ...
    private function _writeDocumentSummaryInformation()
    {
        ...
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x01], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x02], // 2 byte signed integer
                          'data'    => ['data' => 1252]];
        $dataSection_NumProps++;
        
        // GKPIDDSI_CATEGORY : Category
        if ( $this->_phpExcel->getProperties()
                             ->getCategory()
        ) {
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getCategory();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x02], 'offset' => ['pack' => 'V'],
        ...
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x17], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x03],
                          'data'    => ['pack' => 'V', 'data' => 0x000C0000]];
        $dataSection_NumProps++;
        // GKPIDDSI_SCALE : FALSE
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x0B], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x0B], 'data' => ['data' => FALSE]];
        $dataSection_NumProps++;
        // GKPIDDSI_LINKSDIRTY : True if any of the values for the linked properties have changed outside of the application
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x10], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x0B], 'data' => ['data' => FALSE]];
        $dataSection_NumProps++;
        // GKPIDDSI_SHAREDOC : FALSE
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x13], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x0B], 'data' => ['data' => FALSE]];
        $dataSection_NumProps++;
        ...
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x16], 'offset' => ['pack' => 'V'],
                          'type'    => ['pack' => 'V', 'data' => 0x0B], 'data' => ['data' => FALSE]];
        $dataSection_NumProps++;
        ...
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x0D], 'offset' => ['pack' => 'V'],
        ...
        $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x0C], 'offset' => ['pack' => 'V'],
        ...
        foreach ( $dataSection as $dataProp ) {
            ...
            if ( $dataProp[ 'type' ][ 'data' ] == 0x02 ) { // 2 byte signed integer
                ...
                $dataProp[ 'data' ][ 'length' ] = $dataProp[ 'data' ][ 'length' ] +
                                                  ( ( 4 - $dataProp[ 'data' ][ 'length' ] % 4 ) == 4 ? 0 :
                                                      ( 4 - $dataProp[ 'data' ][ 'length' ] % 4 ) );
                $dataProp[ 'data' ][ 'data' ] =
    ...
    private function _writeSummaryInformation()
    {
        ...
        if ( $this->_phpExcel->getProperties()
            ...
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getSubject();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x03], 'offset' => ['pack' => 'V'],
                              'type'    => ['pack' => 'V', 'data' => 0x1E],
                // null-terminated string prepended by dword string length
                              'data'    => ['data' => $dataProp, 'length' => strlen( $dataProp )]];
            $dataSection_NumProps++;
        ...
        if ( $this->_phpExcel->getProperties()
            ...
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getCreator();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x04], 'offset' => ['pack' => 'V'],
                              'type'    => ['pack' => 'V', 'data' => 0x1E],
                // null-terminated string prepended by dword string length
                              'data'    => ['data' => $dataProp, 'length' => strlen( $dataProp )]];
            $dataSection_NumProps++;
        ...
        if ( $this->_phpExcel->getProperties()
            ...
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getKeywords();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x05], 'offset' => ['pack' => 'V'],
                              'type'    => ['pack' => 'V', 'data' => 0x1E],
                // null-terminated string prepended by dword string length
                              'data'    => ['data' => $dataProp, 'length' => strlen( $dataProp )]];
            $dataSection_NumProps++;
        ...
        if ( $this->_phpExcel->getProperties()
            ...
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getDescription();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x06], 'offset' => ['pack' => 'V'],
                              'type'    => ['pack' => 'V', 'data' => 0x1E],
                // null-terminated string prepended by dword string length
                              'data'    => ['data' => $dataProp, 'length' => strlen( $dataProp )]];
            $dataSection_NumProps++;
        ...
        if ( $this->_phpExcel->getProperties()
            ...
            $dataProp = $this->_phpExcel->getProperties()
                                        ->getLastModifiedBy();
            $dataSection[] = ['summary' => ['pack' => 'V', 'data' => 0x08], 'offset' => ['pack' => 'V'],
                              'type'    => ['pack' => 'V', 'data' => 0x1E],
                // null-terminated string prepended by dword string length
                              'data'    => ['data' => $dataProp, 'length' => strlen( $dataProp )]];
            $dataSection_NumProps++;
