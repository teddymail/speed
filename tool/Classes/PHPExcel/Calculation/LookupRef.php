...
class PHPExcel_Calculation_LookupRef
{
    ...
    public static function HYPERLINK( $linkURL = '', $displayName = NULL, PHPExcel_Cell $pCell = NULL )
    {
        ...
        $displayName =
            ( is_null( $displayName ) ) ? '' : PHPExcel_Calculation_Functions::flattenSingleValue( $displayName );
    ...
    public static function INDIRECT( $cellAddress = NULL, PHPExcel_Cell $pCell = NULL )
    {
        ...
        if ( ( !preg_match( '/^' . PHPExcel_Calculation::CALCULATION_REGEXP_CELLREF . '$/i', $cellAddress1,
                            $matches ) ) || ( ( !is_null( $cellAddress2 ) ) &&
                                              ( !preg_match( '/^' . PHPExcel_Calculation::CALCULATION_REGEXP_CELLREF .
     ...
     * @param    cols                 The number of columns, to the left or right, that you want the upper-left cell of
