...
class PHPExcel_Worksheet_BaseDrawing implements PHPExcel_IComparable
{
    ...
    public function setWorksheet( PHPExcel_Worksheet $pValue = NULL, $pOverrideOld = FALSE )
    {
        if ( is_null( $this->_worksheet ) ) {
            ...
            $this->_worksheet->getDrawingCollection()
                             ->append( $this );
        } else {
            if ( $pOverrideOld ) {
                // Remove drawing from old PHPExcel_Worksheet
                $iterator = $this->_worksheet->getDrawingCollection()
                                             ->getIterator();
    ...
    {
        return md5( $this->_name . $this->_description . $this->_worksheet->getHashCode() . $this->_coordinates .
                    $this->_offsetX . $this->_offsetY . $this->_width . $this->_height . $this->_rotation .
                    $this->_shadow->getHashCode() . __CLASS__
        );
    }
